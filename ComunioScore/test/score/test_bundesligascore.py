...
class TestBundesligaScore(unittest.TestCase):
    ...
    def test_vis_lineup_with_rating(self):
        
        lineup_rat = self.bundesliga.vis_lineup_with_rating()
        self.assertIsNone(lineup_rat, msg="lineup rating must be type of None")
